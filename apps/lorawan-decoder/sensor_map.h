/**
 * @file
 * @brief Sensor map module for LoRaWAN MQTT Decoder Service
 * @author GitHub Copilot
 * @date 2024
 * @copyright SPDX-License-Identifier: MIT
 *
 * This module handles loading and caching the sensors_maps.json file
 * which maps devEUI identifiers to sensor types for decoder lookup.
 */
#ifndef LORAWAN_DECODER_SENSOR_MAP_H
#define LORAWAN_DECODER_SENSOR_MAP_H
...
/**
 * @brief Look up a sensor entry by devEUI (only returns lora sources)
 * @param map Pointer to sensor map structure
...
#endif /* LORAWAN_DECODER_SENSOR_MAP_H */
